...
public final class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.0012413178493833276;
        public double trackWidthTicks = 6161.661;

        // feedforward parameters (in tick units)
        public double kS = 0.7214523825669517;
        public double kV = 0.0003858847429303594;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftBack = hardwareMap.get(DcMotorEx.class, "frontRightMotor");
        rightBack = hardwareMap.get(DcMotorEx.class, "frontLeftMotor");
