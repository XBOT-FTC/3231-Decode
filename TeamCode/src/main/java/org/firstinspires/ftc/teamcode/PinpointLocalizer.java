...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -3036.12; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1049.35; // x position of the perpendicular encoder (in tick units)
    }
